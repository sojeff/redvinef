...
class EditPrivate extends DatabaseObject
	{
	
	protected static $table_name = "private_groups_members";
	protected static $db_fields = array('memberid', 'private_user_index_part', 'privateid', 'userguid',
										'date_created', 'access');
	public $memberid;
	...
	public function update()
		...
		$sql .= " Where memberid = ". $database->escape_value($this->userguid) ;
