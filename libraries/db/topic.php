...
class Topic extends DatabaseObject
	...
	protected static $db_fields = array('topicid', 'topic', 'topic_image', 'privateid', 'global');
	public $topicid;
	public $topic;
	public $topic_image;
	public $privateid;
	...
	//class methods		
	public static function top_people()
		{
		global $database;
		$sql = "select userguid from topusers order by rank limit 3 ";
	...
	public static function find_by_id($id=0)
		{
		global $database;
		$sql = "select * from ".self::$table_name." where topicid={$database->escape_value($id)} limit 1";
	...
	public function update()
		...
		$sql .= " Where topicid = ". $database->escape_value($this->topicid) ;
