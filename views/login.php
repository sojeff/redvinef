	...
	<div id="landing">
		...
		<div id="window">
			<div id="form" class="clearfix">
				...
				<div id="right">
					<h3>Signup for Early Access</h3>
					<p>SO:KNO is the best place for sharing knowledge.  We're currently in <strong>BETA</strong> and taking early signups.  Go ahead, signup and we'll get you on the list</p>
				</div>
			</div>
		</div>
		<!-- END LOGIN -->
