	<div class="clearfix" id="header-wrap">
		...
		<!-- HEADER META -->
                <div class="grid_12" id="header-meta">
                    ...
                    <ul id="nav-meta">
                        <li>
                            <a href="sokno_brain.php"><span class="button-info"></span>About</a>
		...
		<div class="grid_12" id="header-nav">
			<ul id="nav-main">
				<li><a <? echo 'href="'.$nav_search_discover.'"'; ?> class="current"><span class="button-discover"></span>Discover</a></li>
				<li><a href="persona.php"><span class="button-persona"></span>Persona</a></li>
				<li><a href="#"><span class="button-settings"></span>Settings</a></li>
			</ul>
			
			<div id="form-search">
				<form method="post" action=<? echo '"'.$nav_search_discover.'"'; ?> >
				<input class="search" type="text" id="field-find" name="field-find" <?php echo 'value="'.$find_knowledge.'"';?> />
