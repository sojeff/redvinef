        ...
        <aside class="grid_3">
            ...
            <section class="connections">
                <ul class="nav">
                    ...
                    <li><a href="persona.php?in=2">Library</a><span class="stat"><?php echo number_format(Jumppad::count_jumppads('personal', $user->userguid,0), 0); //echo $userlevel->curations_count; ?></span></li>
                ...
                <div class="spotlight-info">
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-quad2">
                            <h5>Curations</h5>
                            <h4><?php echo number_format(Jumppad::count_jumppads('personal', $user->userguid,0), 0); //echo $userlevel->curations_count; ?></h4>
                        </div>
                    </div>
